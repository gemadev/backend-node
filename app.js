...
const connection = mongoose.connect('mongodb+srv://coderhouse:35216855@cluster0.rdhrx5i.mongodb.net/desafioClase22?authSource=admin&replicaSet=atlas-f50h5x-shard-0&w=majority&readPreference=primary&appname=MongoDB%20Compass&retryWrites=true&ssl=true', 
error => {
  if (error) {
    console.log(error)
  } else {
